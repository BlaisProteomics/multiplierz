...
if __name__ == '__main__':
    test = [('USERNAME', 'Your name here'),
            ('USEREMAIL', ''),
            ('DECOY', ''),
            ('PEP_ISOTOPE_ERROR', '0'),
            ('FORMAT', 'Mascot generic'),
            ('PRECURSOR', ''),
            ('TAXONOMY', u'All entries'),
            ('DB', u'Marto_FR_Human'),
            ('IT_MODS', (u'Acetyl (Protein N-term)',)),
            ('ITOL', '0.6'),
            ('FILE',
             u'C:\\Users\\Max\\Desktop\\SpectrometerData\\2014-09-30-enolase-100fmol-1.raw-withProc.mgf'),
            ('REPORT', u'AUTO'),
            ('QUANTITATION', u'None'),
            ('COM', ''),
            ('PFA', '0'),
    ...
    #foo = mascot(r'http://cys.dfci.harvard.edu/mascot', version = '2.4')
    #foo.login('pipeline', 'pipeline')
    
    foo = MascotSearcher(r'http://cys.dfci.harvard.edu/mascot')
    foo.login('pipeline', 'pipeline')
    bar = foo.get_fields('2.4')
    foo.search(test)
